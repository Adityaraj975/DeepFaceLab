...
_FUNCTIONPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='opset_import', full_name='onnx.FunctionProto.opset_import', index=8,
...
_FUNCTIONPROTO.fields_by_name['node'].message_type = onnx_dot_onnx__ml__pb2._NODEPROTO
_FUNCTIONPROTO.fields_by_name['opset_import'].message_type = onnx_dot_onnx__ml__pb2._OPERATORSETIDPROTO
...
FunctionProto = _reflection.GeneratedProtocolMessageType('FunctionProto', (_message.Message,), {
  ...
  '__module__' : 'onnx.onnx_operators_ml_pb2'
