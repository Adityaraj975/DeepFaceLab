...
class ExtractSubprocessor(Subprocessor):
    ...
    class Cli(Subprocessor.Cli):
        ...
        def if_exists(path, area):
	        if os.path.isfile(path):
		        image = cv2_imread( path )
		        if (image.shape[0] * image.shape[1]) > area:
			        return True
	        return False
        ...
        def process_data(self, data):
	        ...
	        #directory = "../data_src"
	        #for im_path in os.listdir(directory):
	    ...
	    face = None
            for i in range(0, detections.shape[2]):
                ...
                if confidence > 0.6:
                    ...
                    global startX , startY , endX , endY , m ,n
		...
		return data
            ...
            #shapepredictor = "D:/DeepFaceLab/DeepFaceLab_NVIDIA/_internal/DeepFaceLab/mainscripts/shape_predictor_68_face_landmarks.dat"
            ...
            if face_type == FaceType.MARK_ONLY:
                ...
                face_image = face
                face_image_landmarks = landmarks1
            else:
                image_to_face_mat = LandmarksProcessor.get_transform_mat (landmarks1, kk, face_type)

                face_image = cv2.warpAffine(face, image_to_face_mat, (kk, kk), cv2.INTER_LANCZOS4)
                face_image_landmarks = LandmarksProcessor.transform_points (landmarks1, image_to_face_mat)
